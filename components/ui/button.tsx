  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 transform hover:scale-[1.02] active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        corporate: "bg-corporate-800 text-white hover:bg-corporate-700 hover:shadow-md",
        "corporate-outline":
          "border border-corporate-300 bg-transparent text-corporate-800 hover:bg-corporate-50 hover:border-corporate-400 hover:shadow-sm",
        accent: "bg-accent1-600 text-white hover:bg-accent1-700 hover:shadow-md",
        "accent-outline":
          "border border-accent1-300 bg-transparent text-accent1-700 hover:bg-accent1-50 hover:border-accent1-400 hover:shadow-sm",
      },
      size: {
